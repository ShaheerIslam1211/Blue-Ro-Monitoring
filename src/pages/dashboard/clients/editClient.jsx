...
const tabs = [
  { id: 'details', name: 'Client Details', icon: BuildingOfficeIcon },
];
...
export function EditClient() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await clientsService.updateClient(clientId, formData);
      ...
      setMessage({ text: 'Error updating client. Please try again.', type: 'error' });
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto mt-12 px-4">
      ...
      <div className="mb-8">
        ...
        <h2 className="text-2xl font-medium text-gray-800">Edit Client</h2>
      </div>

  ...
  const statisticsCardsData = [
    {
      ...
      footer: {
        color: "text-blue-500",
        label: "Active clients in the system",
      },
    ...
    },
    {
      ...
      footer: {
        color: "text-blue-500",
        label: "Active regions in the system",
      },
    ...
    },
    {
      ...
      footer: {
        color: "text-blue-500",
        label: "Active plants in the system",
      },
    ...
    <div className="mt-12">
      ...
      {isSuperAdmin() && (
        <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-3">
          {statisticsCardsData.map(({ icon, title, footer, path, ...rest }) => (
